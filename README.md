...
This repo contains my Codex CLI skills. Each skill lives in its own folder with a `SKILL.md` file and optional reference docs under `references/`.
...
| gh-pr-workflow | GitHub CLI pull request creation and formatting. Use when asked to create PRs, generate PR titles/descriptions, add reviewers/labels, or troubleshoot gh auth. | `gh-pr-workflow/SKILL.md` |
...
| tailwind-setup | Set up Tailwind CSS v4 in Expo with react-native-css and NativeWind v5 for universal styling | `tailwind-setup/SKILL.md` |
